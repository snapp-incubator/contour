# Steps
- Don't Deprecate `spec.virtualhost.authorization`
  - It's not like JWT where providers are first-class objects. For auth, we have two kind of configurations:
    - Per VirtualHost
    - PerRoute
- Deprecate `spec.routes.authPolicy.context`
- 
