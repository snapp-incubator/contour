...
func authzRouteOverrideWithAllowedHeaders(t *testing.T, rh ResourceEventHandlerWrapper, c *Contour) {
	...
	newProxyWithRouteAuthzOverride := func(settings *contour_v1.HTTPAuthorizationServerSettings) *contour_v1.HTTPProxy {
	...
	p := newProxyWithRouteAuthzOverride(&contour_v1.HTTPAuthorizationServerSettings{
		AllowedAuthorizationHeaders: []contour_v1.HTTPAuthorizationServerAllowedHeaders{
			{IgnoreCase: false},
		},
	})
